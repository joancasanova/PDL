package sintactico.gramatica;

import java.io.*;
import java.util.*;

import sintactico.Accion;
import sintactico.AccionAceptar;
import sintactico.AccionDesplazar;
import sintactico.AccionReducir;
...
public class ParserGramatica {
    ...
    private static final String FILE_PATH = "src/main/java/sintactico/gramatica/gramatica_corregida.txt";
